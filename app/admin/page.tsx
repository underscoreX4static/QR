...
export default async function AdminPage() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-gray-900">Vue globale</h2>

      {/* Stats */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Commandes totales', value: stats.totalOrders, color: 'text-blue-600' },
          { label: 'En cours', value: stats.activeOrders, color: 'text-orange-600' },
          { label: 'Revenus livrés', value: `${stats.revenue.toFixed(2)}€`, color: 'text-green-600' },
          { label: 'Livreurs actifs', value: stats.drivers, color: 'text-purple-600' },
        ].map((stat) => (
