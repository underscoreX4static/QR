          ...
          <tbody className="divide-y divide-gray-50">
            {(partners ?? []).map((p) => (
              <tr key={p.id} className="hover:bg-gray-50">
                ...
                <td className="px-5 py-3 text-gray-600 max-w-[180px] truncate">{p.address}</td>
                <td className="px-5 py-3 text-gray-600">{p.contact_name}</td>
                <td className="px-5 py-3 text-gray-600">{p.contact_phone}</td>
