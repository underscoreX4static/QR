      ...
      >
        ...
        <div className="shrink-0 border-b border-gray-100 px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500">Order #{shortId}</p>
          </div>
        ...
        <div ref={scrollerRef} className="flex-1 overflow-y-auto px-4 py-3 space-y-2 bg-gray-50">
          {loading && messages.length === 0 ? (
            ...
            <div className="text-center text-xs text-gray-400 py-8 space-y-1">
              <p>No messages yet</p>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  rows={1}
                  maxLength={2000}
                  className="flex-1 resize-none rounded-2xl border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 max-h-24"
                />
                <button
                  onClick={send}
