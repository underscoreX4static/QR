      ...
      {open && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-sm shadow-xl">
            <h3 className="font-bold text-gray-900 dark:text-gray-100 mb-4">Nouveau QR Code</h3>
            ...
            <form onSubmit={submit} className="space-y-3">
              ...
              <div>
                <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">Partenaire <span className="text-gray-400 dark:text-gray-500">(optionnel)</span></label>
                <select
